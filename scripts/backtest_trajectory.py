...
SETTINGS = {
    ...
    "V14 all analogs":     dict(LEVEL2_MODE="analog_countdown_mixture",
                                ...
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    # Ablation: which of the three bundled V14 changes costs the accuracy?
    # direct envelope (Finding 1+2 structure) x {max, mixture} x {1-step, min-hist}
    "abl direct+max+1step": dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_COMBINE="max", V14_MONOTONE="one_step",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    "abl direct+max+minhist": dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_COMBINE="max", V14_MONOTONE="min_history",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    "abl direct+mix+minhist": dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_COMBINE="mixture", V14_MONOTONE="min_history",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    # The combine axis is only distinguishable where >1 analog survives, which
    # needs the censored batch 47 included. Batch 49 then has two components.
    "abl all+max+1step":   dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_REQUIRE_UNCENSORED_ANALOGS=False,
                                V14_COMBINE="max", V14_MONOTONE="one_step",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    "abl all+max+minhist": dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_REQUIRE_UNCENSORED_ANALOGS=False,
                                V14_COMBINE="max", V14_MONOTONE="min_history",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    "abl all+mix+minhist": dict(LEVEL2_MODE="analog_countdown_mixture",
                                V14_REQUIRE_UNCENSORED_ANALOGS=False,
                                V14_COMBINE="mixture", V14_MONOTONE="min_history",
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    ...
    "V11 readiness mix":   dict(LEVEL2_MODE="readiness_mixture",
                                ENFORCE_READINESS_MONOTONICITY=False,
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
    "V12 monotone ready":  dict(LEVEL2_MODE="readiness_mixture",
                                ENFORCE_READINESS_MONOTONICITY=True,
                                PARAMETRIC_LEVEL1=False, SEPARATE_ZERO_GAP_MODE=True,
                                WEIGHT_ANALOGS_BY_SURVIVAL=False),
