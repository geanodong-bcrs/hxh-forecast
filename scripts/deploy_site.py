...
ALLOW = [
    ...
    # One-off analysis page, generated by scripts/build_wait_analysis.py.
    ("site/125-day-wait.html", "125-day-wait.html"),
    ("scripts", "scripts"),
...
DENY = [
    ...
    # Added 2026-09-16. docs/editorial_notes.md and docs/human0_ideas.md reached
    # the public repo because ALLOW takes `docs` wholesale and .gitignore only
    # governs the VAULT's git -- this script copies from the filesystem, so an
    # ignored file was copied anyway. They now live in private/, which no ALLOW
