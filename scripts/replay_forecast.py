...
Use `--revision-v2`, `--revision-v3`, `--revision-v4`, `--revision-v5`, `--revision-v6`, `--revision-v6-gated`, `--revision-v6-buffer`, `--revision-v7-two-gap`, `--revision-v8-parametric`, `--revision-v9`, `--revision-v10`, `--revision-v11`, `--revision-v12`, or `--revision-v13` to reconstruct an
...
def main():
    ...
    revision_v13 = "--revision-v13" in sys.argv
    hi = live_from()
    ch = target_chapter()
    ...
    for d in dates:
        ...
        rid = (d.strftime("%Y%m%dT235600Z") if revision_v13 else
               d.strftime("%Y%m%dT235700Z") if revision_v12 else
